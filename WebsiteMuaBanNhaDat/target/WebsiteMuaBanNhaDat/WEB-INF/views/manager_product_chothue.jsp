        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>   
                ...
                <table id="danhmuc">
                    ...
                    <tr>
                        <td><%--=countt--%></td>
                        <td><img style="width:100px;height:50px;" src="" >
                        ...
                        <%--
                            if (ct.getChothue_status() == 0) {
                            --%>
  <!-- đã chỉnh sửa -->                          <span style="border: 2px dashed red;"><a style="color: rgba(122,231,0,0.8);font-size:15px;" href="MoHinh.jsp?ChoThueID="><i class="fas fa-unlock-alt"></i>Đi Duyệt</a></span>
                            <%--
                                }
                            --%>
  <!-- đã chỉnh sửa -->                          <span><a href="DuyetBai?command=xoa&ChoThueID="><i class="fas fa-trash-alt">Xóa</i></a></span></td>
