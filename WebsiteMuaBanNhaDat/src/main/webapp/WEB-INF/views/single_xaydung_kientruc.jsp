    ...
    <body>
        ...
        %>
            <div id="top-phongthuy">
                <a href="index.jsp">Home></a><a href="xaydung_kientruc.jsp"><span>Xây Dưng- Kiến Trúc></span></a><span><%--out.print(xaydung_kientrucDAO.getChitiet(i).getXaydung_kientruc_TieuDe() ); --%></span>
        </div>
