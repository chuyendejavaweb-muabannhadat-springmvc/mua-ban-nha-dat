...
<body
	...
	<div class="a1">
		...
		<div class="a2">
				<div
					...
					<p><span>
						<i style="padding-left: 53px; float: right; color: white;"
							class="far fa-calendar-alt">Ngày Đăng Bài: ${postNews.start_day}</i></span>
					</p>
				</div>
				<div class="single">
					<div>
						<a href="#"> <img class="a2-1"
							style="border: 2px solid #312f2c; float: left; height: 324px; width: 576px;"
					...
					<div class="as">
						...
						<p
							style="font-size: 28px; color: white; padding-left: 729px; background-color: rgba(0, 0, 0, 0.4); border-top-right-radius: 45px;">Thông
							Tin Liên Hệ
						<p>
						<div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="far fa-caret-square-up"></i><strong>Tiêu Đề</strong><span
										style="margin-left: 166px;"> ${postNews.title} </span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fab fa-accusoft"></i><strong>Loại tin</strong><span
										style="margin-left: 145px;">
										${postNews.news_id.name} </span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fas fa-money-bill"></i><strong>Giá</strong><span
										style="margin-left: 197px;"> ${postNews.detail.price} Tỷ VNĐ
									</span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fab fa-laravel"></i><strong>Diện Tích</strong><span
										style="margin-left: 147px;"> ${postNews.detail.area} m<sup>2</sup>
									</span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fas fa-address-book"></i><strong>Họ Tên
										Người Đăng</strong><span style="margin-left: 72px;">
										${postNews.user_id.fullname} </span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fas fa-phone-square"></i><strong>Số Điện
										Thoại</strong><span style="margin-left: 117px;">
										${postNews.detail.phone} </span>
								</p>
							</div>
							<div
								style="border: 2px solid #00c6d7; border-top-right-radius: 23px; height: auto; color: white;">
								<p style="padding-left: 591px; font-size: 18px;">
									<i class="fas fa-compass"></i><strong>Vị Trí</strong><span
										style="margin-left: 185px;"> ${postNews.detail.address} </span>
								</p>
							</div>
						</div>
	...
	<div class="as1" style="border: 2px solid black; height: auto;">
		<p
			...
			tả chi tiết</p>
		<p
			style="padding-left: 26px; padding-right: 26px; font-size: 20px; color: white;">
			<%--=p2.getProductDescription()--%>
		</p>
		<div class="clearfix"></div>
		<img
			style="border: 2px solid #312f2c; height: 508px; width: 737px; margin-left: 201px; margin-top: 25px; margin-bottom: 25px;"
			src="<%--=p2.getProductImage()%>" alt="" >
                </div>

                <div class="clearfix"> </div>
                <div style="margin-top: 56px;border: 1px solid white;background: rgba(255,255,255, 0.3);">
                    <div class="fb-comments" data-href="http://localhost:8081/MuaBanNha/single.jsp?productID=<%--=request.getParameter("productID")--%>"
			data-width="700" data-numposts="5">
	</div>
	<div></div>
	</div>
				...
				<div class="content-top-in" style="width: 932px;">
					...
					<div class="col-md-3 md-col"
						...
						<div class="col-md" style="background: rgba(0, 0, 0, 0.4)">
							<div>
								<i class="fas fa-home" style="color: white;"> <%--=pp.getHinhthuc() --%>
								</i><span><i
									style="padding-left: 53px; float: right; color: white;"
									class="far fa-calendar-alt"> <%--=pp.getNgaydang() --%>
								</i></span>
							</div>
							<div class="clearfix"></div>
							...
							<div class="top-content">
								<h5>
									<a style="color: white;"
										href="single.jsp?productID=<%--=pp.getProductID() --%>"> <%--=pp.getProductName()--%>
									</a>
								</h5>
								<h5 style="padding: 0px; margin-top: -9px;">
									<i class="fas fa-compass" style="color: white;"> <%--=pp.getVitri() --%>
									</i>
								</h5>
								<h5 style="padding: 0px; margin-top: 4px;">
									<i class="fab fa-laravel"
										style="color: white; padding: 0px; margin-top: -9px;"> <%--=pp.getProductPrice() --%>m<sup>2</sup>
									</i>
								</h5>
								<%--
                                                Users users = null;
								...
								<div class="white">
									...
									<%--
                                                ...
                                                --%>
									<p class="dollar">
										<span> <%--=pp.getProductPrice() --%>
										</span><span>Tỷ</span><span class="in-dollar">VNĐ</span>
									</p>
									<div class="clearfix"></div>
								</div>
								<%--
					...
					<div class="col-md-3 md-col" style="margin-top: 30px;">
						<div class="col-md" style="background: rgba(0, 0, 0, 0.4)">
							...
							<div class="top-content">
								<h5>
									<a style="color: white;"
										href="single.jsp?productID=<%--=pp.getProductID() --%>"">
										<%--=pp.getProductName()--%>
									</a>
								</h5>
								<h5 style="padding: 0px; margin-top: -9px;">
								...
								<h5 style="padding: 0px; margin-top: 4px;">
									<i class="fab fa-laravel"
										style="color: white; padding: 0px; margin-top: -9px;"> <%--=pp.getDientich() --%>m<sup>2</sup>
									</i>
								</h5>
								<%--
                                                Users users = null;
