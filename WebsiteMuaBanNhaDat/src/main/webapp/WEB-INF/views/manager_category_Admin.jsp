...
<!-- đã chỉnh sửa -->   <td><span><a href="update_category_Admin.jsp?command=update&category_id="><i class="far fa-edit"></i></a></span>|||<span><a href="ManagerCategoryServlet?command=delete&category_id="><i class="fas fa-trash-alt"></i></a></span></td>
                    </tr>
                    <%-- }--%>
                </table>
            </div>
